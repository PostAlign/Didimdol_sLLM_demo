...
아래는 Google 의 Gemma Terms of Use (https://ai.google.dev/gemma/terms) 전문 사본입니다.
Gemma Terms of Use 는 Google LLC 가 정하며, PostAlign 은 이를 수정할 수 없습니다.
원본과 차이가 있을 경우 위 URL 의 원문이 우선합니다.
...
Note: Previous versions of these Terms are archived here.
